...
import InvoiceVerify from "./pages/Invoices/InvoiceVerify.jsx";
import InvoicePayment from "./pages/Invoices/InvoicePayment.jsx";
        ...
        <Routes>
          ...
          >
            ...
            <Route path="postings">
              ...
              <Route path="new" element={<CreatePosting />} />
              <Route path="analytics" element={<PostingAnalytics />} />
              <Route path="history/:employeeId" element={<EmployeeHistory />} />
              <Route path=":id" element={<PostingDetails />} />
            </Route>
            ...
            <Route path="invoices">
              ...
              <Route path=":id/verify" element={<InvoiceVerify />} />
